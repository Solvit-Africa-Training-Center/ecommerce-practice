...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    const productSubCategories = await queryInterface.sequelize.query(`SELECT COUNT(*) as count FROM product_sub_categories;`, {
    ...
    const subCategories = [
      ...
      {
        productSubCatId: '37bd634e-df79-4eba-a830-26da92dcc9e6',
        name: 'Laptops',
        productCatId: '0ddbea7e-6e69-4bd0-a1b1-7bf0275ebfbe', // Electronics
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      {
        productSubCatId: 'b248e043-f6ee-486e-87b8-85289176d28b',
        name: 'Tablets',
        productCatId: '0ddbea7e-6e69-4bd0-a1b1-7bf0275ebfbe', // Electronics
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      {
        productSubCatId: '187abcad-68d6-4221-8e64-c9ee33448917',
        name: 'Men\'s Clothing',
      ...
      {
        productSubCatId: '61df62ed-fd41-4a02-be1a-1ab64fe4d2f5',
      ...
      // Books subcategories
      {
        productSubCatId: '055a86e4-c4fa-40f4-9a5a-2a8c3fe1a6eb',
        name: 'Fiction',
      ...
      {
        productSubCatId: '01100301-3a4c-4d97-9023-4f839bb991c9',
        name: 'Technical',
        productCatId: 'a4a61c4d-2b57-469f-9386-4c88c13bea24', // Books
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      {
        productSubCatId: 'd7b1461e-aaa1-47d5-8563-ef5d13b57855',
        name: 'Furniture',
      ...
      {
        productSubCatId: '690c91fb-b8e7-400b-ae81-a7ee07add23c',
        name: 'Garden Tools',
        productCatId: '762cd95b-1840-4261-98d0-01e35626d8b7', // Home & Garden
        createdAt: new Date(),
        updatedAt: new Date(),
